...
public class ArchiveFilesApp
{
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.out.println("Usage: java -jar ArchiveFilesApp <stack_id> (1..6)");
      return;
    }
    ...
    final ArchiveFilesApp app = 
        context.getBean(ArchiveFilesApp.class);
    app.start();
  }
}
